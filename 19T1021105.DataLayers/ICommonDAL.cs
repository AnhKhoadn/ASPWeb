...
namespace _19T1021105.DataLayers
{
    ...
    {
        /// <summary>
        /// Tìm kiếm và hiển thị danh sách dữ liệu dưới dạng phân trang
        /// </summary>
        /// <param name="page">Trang cần hiển thị</param>
        /// <param name="pageSize">Số dòng hiển thị trên mỗi trang (bằng 0 nếu không phân trang)</param>
        /// <param name="searchValue">Giá trị cần tìm (chuỗi rỗng nếu không tìm kiếm, tức là truy vấn lấy toàn bộ dữ liệu)</param>
        /// <returns></returns>
